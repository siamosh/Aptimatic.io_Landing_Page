        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <a href="#" className="flex items-center gap-2">
            <svg viewBox="0 0 204 40" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: "34px", display: "block" }}>
              ...
              <line x1="20" y1="2" x2="3" y2="38" stroke="url(#nlg2)" strokeWidth="3" strokeLinecap="round"/>
              <line x1="20" y1="2" x2="37" y2="38" stroke="url(#nlg2)" strokeWidth="3" strokeLinecap="round"/>
              <line x1="10.5" y1="22" x2="29.5" y2="22" stroke="url(#nlg2)" strokeWidth="3" strokeLinecap="round"/>
              <circle cx="20" cy="2" r="3.2" fill="url(#nlg2)"/><circle cx="3" cy="38" r="3.2" fill="url(#nlg2)"/>
              <circle cx="37" cy="38" r="3.2" fill="url(#nlg2)"/><circle cx="10.5" cy="22" r="3.2" fill="url(#nlg2)"/>
              <circle cx="29.5" cy="22" r="3.2" fill="url(#nlg2)"/>
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2 opacity-50 grayscale">
            <svg viewBox="0 0 204 40" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: "24px", display: "block" }}>
              ...
              <circle cx="20" cy="2" r="3.2" fill="url(#nlg3)"/><circle cx="3" cy="38" r="3.2" fill="url(#nlg3)"/>
              <circle cx="37" cy="38" r="3.2" fill="url(#nlg3)"/><circle cx="10.5" cy="22" r="3.2" fill="url(#nlg3)"/>
