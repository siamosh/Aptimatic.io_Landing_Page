        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <a href="#" className="flex items-center gap-2">
            <svg viewBox="0 0 204 40" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: "34px", display: "block" }}>
              ...
              <path d="M 5,37 L 15,4" stroke="url(#nlg2)" strokeWidth="3" strokeLinecap="round" fill="none"/>
              <path d="M 22,10 Q 35,24 37,37" stroke="url(#nlg2)" strokeWidth="3" strokeLinecap="round" fill="none"/>
              <circle cx="5" cy="37" r="3.2" fill="url(#nlg2)"/>
              <circle cx="15" cy="4" r="3.2" fill="url(#nlg2)"/>
              <circle cx="22" cy="10" r="3.2" fill="url(#nlg2)"/>
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2 opacity-50 grayscale">
            <svg viewBox="0 0 204 40" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: "24px", display: "block" }}>
              ...
              <path d="M 5,37 L 15,4" stroke="url(#nlg3)" strokeWidth="3" strokeLinecap="round" fill="none"/>
              <path d="M 22,10 Q 35,24 37,37" stroke="url(#nlg3)" strokeWidth="3" strokeLinecap="round" fill="none"/>
              <circle cx="5" cy="37" r="3.2" fill="url(#nlg3)"/>
              <circle cx="15" cy="4" r="3.2" fill="url(#nlg3)"/>
              <circle cx="22" cy="10" r="3.2" fill="url(#nlg3)"/>
